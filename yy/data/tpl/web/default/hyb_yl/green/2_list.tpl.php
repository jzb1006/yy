                          	...
                          	<div class="form-group">
								...
								<div class="col-sm-4">
									<select name="qx_id" id="category_parentjg" style="width: 100%;">
										...
										<option value="1" <?php  if($qx_id == '1') { ?> selected="" <?php  } ?>>医院</option>
										<option value="2" <?php  if($qx_id == '2') { ?> selected="" <?php  } ?>>药房</option>
										<option value="3" <?php  if($qx_id == '3') { ?> selected="" <?php  } ?>>体检机构</option>
										<option value="4" <?php  if($qx_id == '4') { ?> selected="" <?php  } ?>>诊所</option>
									</select>
									<select id="category_childjg" name="h_id" style="width: 100%;">
                                        <option value="">请选择二级分类</option>
                                        <?php  if(is_array($quanxian2)) { foreach($quanxian2 as $qx) { ?>
                                        <option value="<?php  echo $qx['hid'];?>" <?php  if($h_id == $qx['hid']) { ?> selected <?php  } ?>><?php  echo $qx['agentname'];?></option>
                                        <?php  } } ?>
                                    </select>
								</div>
							</div>
