		...
		<div class="dashb-c-d">
			<div class="dashb-c-t1 dashb-c-top">
				<div class="dashb-c-p-title">
					<span>财务概况</span><i>更新时间：<?php  echo $todayss;?></i>
				</div>
				<div class="dashb-c-t1-c">
					<div class="dashb-c-p">
						...
						<div class="dashb-c-p-r">
							<div class="h2">收入金额(元)</div>
							<div class="h1" id="html-allmoney-today"><?php  echo $today['money'];?></div>
							<div class="p" id="html-allmoney-yestoday">昨日：<?php  echo $yesterday['money'];?></div>
						</div>
					</div>
					<div class="dashb-c-p">
						<div class="dashb-c-p-r">
							<div class="h2">退款金额(元)</div>
							<div class="h1" id="html-refund-today"><?php  echo $today['refund'];?></div>
							<div class="p" id="html-refund-yestoday">昨日：<?php  echo $yesterday['refund'];?></div>
						</div>
					</div>
					<div class="dashb-c-p">
						<div class="dashb-c-p-l">
						...
						<div class="dashb-c-p-r">
							<div class="h2">提现金额</div>
							<div class="h1" id="html-store-today"><?php  echo $today['tixian'];?></div>
							<div class="p" id="html-store-yestoday">昨日：<?php  echo $yesterday['tixian'];?></div>
						</div>
					</div>
					<div class="dashb-c-p">
						<div class="dashb-c-p-r">
							<div class="h2">平台账户（元）</div>
							<div class="h1" id="html-newcharge-today"><?php  echo $today['money'];?></div>
							<div class="p" id="html-newcharge-yestoday">昨日：<?php  echo $yesterday['money'];?></div>
						</div>
					</div>
			...
			<div class="dashb-c-t1 dashb-c-top">
                ...
                <div class="dashb-c-t1-c">
                    <div class="item">
                        ...
                        <div class="item_body">
                            <a href=""><div class="item_info">待发货订单：<span id="order-dfh"><?php  echo $today['fahuo_order'];?></span></div></a>
                            <a href=""><div class="item_info">待退款订单：<span id="order-dtk"><?php  echo $today['refund_order'];?></span></div></a>
							<a href=""><div class="item_info">已退订单：<span id="order-sqtk"><?php  echo $today['yitui_order'];?></span></div></a>
                        </div>
                    </div>
                                                            <div class="item">
                        <div class="item_tit">财务相关</div>
                        <div class="item_body">
                            <a href="<?php  echo $this->createWebUrl('financ',array('op'=>'givemoney','ac'=>'givemoney','status'=>'','type'=>'0','account_type'=>'','keywordtype'=>'','start'=>'','end'=>'','hid'=>$_SESSION['hid']))?>"><div class="item_info">专家提现申请：<span id="storeapply"><?php  echo $today['zj_tixian'];?></span></div></a>
                            <a href="<?php  echo $this->createWebUrl('financ',array('op'=>'givemoney','ac'=>'givemoney','status'=>'','type'=>'2','account_type'=>'','keywordtype'=>'','start'=>'','end'=>'','hid'=>$_SESSION['hid']))?>"><div class="item_info">机构提现申请：<span id="agentapply"><?php  echo $today['jg_tixian'];?></span></div></a>
                            <a href="<?php  echo $this->createWebUrl('financ',array('op'=>'givemoney','ac'=>'givemoney','status'=>'','type'=>'4','account_type'=>'','keywordtype'=>'','start'=>'','end'=>'','hid'=>$_SESSION['hid']))?>"><div class="item_info">用户提现申请：<span id="disapply"><?php  echo $today['user_tixian'];?></span></div></a>
                        </div>
                    </div>
			...
			<div class="dashb-c-t2 dashb-c-top">
				...
				<div class="page-content">
			        <form action="./index.php"  class="form-horizontal" onsubmit='return checkform()'>
			           ...
			           <input type="hidden" name="op"  value="financialstaus" />
			           <input type="hidden" name="ac" value="financialstaus" />
