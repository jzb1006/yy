            ...
            <table class="table table-hover">
                <thead class="navbar-inner">
                    <tr>
                        ...
                        <th style="width:10%;">积分变化</th>
                        <th style="width:10%;">当前积分</th>
...
<script type="text/javascript">
	...
	$('#de1').delegate('.pass_delete','click',function(e){
		...
		if(!state)  return;
			$.post("./index.php?c=site&a=entry&do=member&op=integraldelete&ac=integral&m=hyb_yl", { ids : ids }, function(data){
				if(data.errno=='1'){ 
					util.tips("操作成功！");
					setTimeout(function(){ 
