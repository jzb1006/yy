				...
				<div class="dashb-c-t1-c">
					<div class="dashb-c-p">
						...
						<div class="dashb-c-p-r">
							<div class="h2">新增套餐数(个)</div>
							<div class="h1" id="html-allmoney-today"><?php  echo $today['taocan'];?></div>
							<div class="p" id="html-allmoney-yestoday">昨日：<?php  echo $yesterday['taocan'];?></div>
						</div>
					</div>
					<div class="dashb-c-p">
						<div class="dashb-c-p-r">
							<div class="h2">新增体检(人)</div>
							<div class="h1" id="html-refund-today"><?php  echo $today['tijian'];?></div>
							<div class="p" id="html-refund-yestoday">昨日：<?php  echo $yesterday['tijian'];?></div>
						</div>
					</div>
					<div class="dashb-c-p">
						<div class="dashb-c-p-l">
						...
						<div class="dashb-c-p-r">
							...
							<div class="h1" id="html-store-today"><?php  echo $today['hospital'];?></div>
							<div class="p" id="html-store-yestoday">昨日：<?php  echo $yesterday['hospital'];?></div>
						</div>
					</div>
					<div class="dashb-c-p">
						<div class="dashb-c-p-r">
					...
					<div class="dashb-c-p">
						...
						<div class="dashb-c-p-r">
							<div class="h2">新增对比数</div>
							<div class="h1" id="html-newmember-today"><?php  echo $today['duibi'];?></div>
							<div class="p" id="html-newmember-yestoday">昨日：<?php  echo $yesterday['duibi'];?></div>
						</div>
					</div>
					<div class="dashb-c-p">
						<div class="dashb-c-p-r">
							<div class="h2">潜在患者数</div>
							<div class="h1" id="html-paymember-today"><?php  echo $today['huanzhe'];?></div>
							<div class="p" id="html-paymember-yestoday">昨日：<?php  echo $yesterday['huanzhe'];?></div>
						</div>
					</div>
					<div class="dashb-c-p">
						<div class="dashb-c-p-l">
						...
						<div class="dashb-c-p-r">
							...
							<div class="h1" id="html-order-today"><?php  echo $today['tijian'];?></div>
							<div class="p" id="html-order-yestoday">昨日：<?php  echo $yesterday['tijian'];?></div>
						</div>
					</div>
					<div class="dashb-c-p">
						<div class="dashb-c-p-r">
			...
			<div class="dashb-c-t1 dashb-c-top">
                ...
                <div class="dashb-c-t1-c">
                    <div class="item">
                        ...
                        <div class="item_body">
                            <a href=""><div class="item_info">待核销订单：<span id="order-dfh"><?php  echo $hexiao;?></span></div></a>
                            <a href=""><div class="item_info">待退款订单：<span id="order-dtk"><?php  echo $tuikuan;?></span></div></a>
							<a href=""><div class="item_info">申请退款订单：<span id="order-sqtk"><?php  echo $yitui;?></span></div></a>
                        </div>
                    </div>
                                                            <div class="item">
                        <div class="item_tit">患者相关</div>
                        <div class="item_body">
                            <a href="<?php  echo $this->createWebUrl('physical',array('op'=>'patient','ac'=>'patient'))?>"><div class="item_info">新增潜在患者：<span id="storeapply"><?php  echo $huanzhe;?></span></div></a>
                            <a href="<?php  echo $this->createWebUrl('physical',array('op'=>'dblist','ac'=>'dblist'))?>"><div class="item_info">新增报告对比：<span id="agentapply"><?php  echo $baogao;?></span></div></a>
    ...
    $(function () {
        $('#container').highcharts({
            ...
            series: [{
	            ...
	            data: [
	                <?php  if(is_array($datas)) { foreach($datas as $key => $row) { ?>
	                <?php  if($key>0) { ?>,<?php  } ?><?php  echo $row['hospital'];?>
	                <?php  } } ?>
	            ]
	        }],
    	});
