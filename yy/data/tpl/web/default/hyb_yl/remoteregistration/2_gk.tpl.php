				...
				<div class="dashb-c-t1-c">
					<div class="dashb-c-p">
						...
						<div class="dashb-c-p-r">
							<div class="h2">新增挂号(个)</div>
							<div class="h1" id="html-allmoney-today"><?php  echo $today['guahao'];?></div>
							<div class="p" id="html-allmoney-yestoday">昨日：<?php  echo $yesterday['guahao'];?></div>
						</div>
					</div>
					<div class="dashb-c-p">
						<div class="dashb-c-p-r">
							<div class="h2">今日在线医生(个)</div>
							<div class="h1" id="html-refund-today"><?php  echo $today['doc'];?></div>
							<div class="p" id="html-refund-yestoday">昨日：<?php  echo $yesterday['doc'];?></div>
						</div>
					</div>
					...
					<div class="dashb-c-p">
						<div class="dashb-c-p-r">
							...
							<div class="h1" id="html-newcharge-today"><?php  echo $today['pay'];?></div>
							<div class="p" id="html-newcharge-yestoday">昨日：<?php  echo $yesterday['pay'];?></div>
						</div>
					</div>
					<div class="dashb-c-p">
						<div class="dashb-c-p-l">
			...
			<div class="dashb-c-t1 dashb-c-top">
                ...
                <div class="dashb-c-t1-c">
                    <div class="item">
                        ...
                        <div class="item_body">
                            <a href=""><div class="item_info">待支付订单：<span id="order-dfh"><?php  echo $today['pays'];?></span></div></a>
                            <a href=""><div class="item_info">待退款订单：<span id="order-dtk"><?php  echo $today['refund'];?></span></div></a>
							<a href=""><div class="item_info">待就诊订单：<span id="order-sqtk"><?php  echo $today['jiuzhen'];?></span></div></a>
                        </div>
                    </div>
                                                            <div class="item">
                        <div class="item_tit">患者相关</div>
                        <div class="item_body">
                            <a href=""><div class="item_info">新增挂号患者：<span id="storeapply"><?php  echo $today['guahao'];?></span></div></a>
			...
			<div class="dashb-c-t2 dashb-c-top">
				...
				<div class="dashb-c-t2-c">
					...
					<div class="dashb-c-p">
						<div class="dashb-c-p-r">
							...
							<div class="h1" id="html-sevenmoney"><?php  echo $seven['pay'];?></div>
						</div>
					</div>
					<div class="dashb-c-p">
						<div class="dashb-c-p-r">
				...
				<div class="page-content">
			        <form action=""  class="form-horizontal" onsubmit='return checkform()'>
			           ...
			           <input type="hidden" name="ac" value="remoteregistration" />
