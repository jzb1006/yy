						...
						<table class="table table-hover">
							...
							<tbody>
								<tr>
									...
									<td class="text-left">
										<label class="label label-warning"><?php  echo $item['total_money'];?></label>
									</td>
									<td>
									...
									<td style="overflow:visible;">
                                        ...
                                        <a class="btn btn-primary btn-sm" href="<?php  echo $this->createWebUrl('team',array('op'=>'shouyi','zid'=>$item['zid'],'ac'=>'shouyi','hid'=>$_SESSION['hid']))?>" title="">收益明细</a>
                                         <a class="btn btn-primary btn-sm" href="<?php  echo $this->createWebUrl('team',array('op'=>'tixian','zid'=>$item['zid'],'ac'=>'shouyi','hid'=>$_SESSION['hid']))?>" title="">提现记录</a>
                                          <a class="btn btn-primary btn-sm" href="<?php  echo $this->createWebUrl('team',array('op'=>'huanzhe','zid'=>$item['zid'],'ac'=>'huanzhe','hid'=>$_SESSION['hid']))?>" >患者管理</a>
                                        ...
                                        <!-- <a class="btn btn-warning btn-sm"  href="/index.php?c=site&a=entry&do=team&op=scheduling&ac=scheduling&m=hyb_yl&zid=<?php  echo $item['zid'];?>&hid=<?php  echo $_SESSION['hid'];?>">排班</a> -->
