				...
				<div class="dashb-c-t1-c">
					<div class="dashb-c-p">
						...
						<div class="dashb-c-p-r">
							<div class="h2">新增线上团队(个)</div>
							<div class="h1" id="html-allmoney-today"><?php  echo $today_add_team;?></div>
							<div class="p" id="html-allmoney-yestoday">昨日：<?php  echo $yes_add_team;?></div>
						</div>
					</div>
					<div class="dashb-c-p">
						<div class="dashb-c-p-r">
							<div class="h2">新增社区团队(个)</div>
							<div class="h1" id="html-refund-today"><?php  echo $today_add_shequ;?></div>
							<div class="p" id="html-refund-yestoday">昨日：<?php  echo $yes_add_shequ;?></div>
						</div>
					</div>
					<div class="dashb-c-p">
						<div class="dashb-c-p-l">
						...
						<div class="dashb-c-p-r">
							<div class="h2">新增社区数</div>
							<div class="h1" id="html-store-today"><?php  echo $today_add_shequ;?></div>
							<div class="p" id="html-store-yestoday">昨日：<?php  echo $yes_add_shequ;?></div>
						</div>
					</div>
					<div class="dashb-c-p">
						<div class="dashb-c-p-r">
							<div class="h2">今日收益（元）</div>
							<div class="h1" id="html-newcharge-today"><?php  echo $today_money;?></div>
							<div class="p" id="html-newcharge-yestoday">昨日：<?php  echo $yes_money;?></div>
						</div>
					</div>
					<div class="dashb-c-p">
						<div class="dashb-c-p-l">
						...
						<div class="dashb-c-p-r">
							<div class="h2">新增签约数</div>
							<div class="h1" id="html-newmember-today"><?php  echo $today_qianyue;?></div>
							<div class="p" id="html-newmember-yestoday">昨日：<?php  echo $yes_qianyue;?></div>
						</div>
					</div>
					<div class="dashb-c-p">
						<div class="dashb-c-p-r">
							<div class="h2">新增团队服务包</div>
							<div class="h1" id="html-paymember-today"><?php  echo $today_fuwu;?></div>
							<div class="p" id="html-paymember-yestoday">昨日：<?php  echo $yes_fuwu;?></div>
						</div>
					</div>
					<div class="dashb-c-p">
						<div class="dashb-c-p-l">
						...
						<div class="dashb-c-p-r">
							...
							<div class="h1" id="html-order-today"><?php  echo $today_order;?></div>
							<div class="p" id="html-order-yestoday">昨日：<?php  echo $yes_order;?></div>
						</div>
					</div>
					<div class="dashb-c-p">
						<div class="dashb-c-p-r">
							<div class="h2">支付订单数</div>
							<div class="h1" id="html-payorder-today"><?php  echo $today_qianyue;?></div>
							<div class="p" id="html-payorder-yestoday">昨日：<?php  echo $yes_qianyue;?></div>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="dashb-c-t1 dashb-c-top">
                ...
                <div class="dashb-c-t1-c">
                    <div class="item">
                        ...
                        <div class="item_body">
                            <a href="<?php  echo $this->createWebUrl('sign',array('op'=>'orderlist','ifpay'=>'0','keyword'=>'','start'=>'','end'=>'','key_words'=>'','hid'=>$_SESSION['hid']))?>"><div class="item_info">待签约订单：<span id="order-dfh"><?php  echo $daiqian;?></span></div></a>
                            <a href="<?php  echo $this->createWebUrl('sign',array('op'=>'orderlist','ifpay'=>'3','keyword'=>'','start'=>'','end'=>'','key_words'=>'','hid'=>$_SESSION['hid']))?>"><div class="item_info">待退款订单：<span id="order-dtk"><?php  echo $tuikuan;?></span></div></a>
							<!-- <a href="<?php  echo $this->createWebUrl('sign',array('op'=>'orderlist','ifpay'=>'0','keyword'=>'','start'=>'','end'=>'','key_words'=>''))?>"><div class="item_info">待续费订单：<span id="order-sqtk"><?php  echo $xufei;?></span></div></a> -->
                        </div>
                    </div>
                                                            <div class="item">
                        <div class="item_tit">患者相关</div>
                        <div class="item_body">
                            <a href="<?php  echo $this->createWebUrl('sign',array('op'=>'orderlist','ifpay'=>'','keyword'=>'','start'=>'','end'=>'','key_words'=>'','hid'=>$_SESSION['hid']))?>"><div class="item_info">新增签约患者：<span id="storeapply"><?php  echo $today_order;?></span></div></a>
				...
				<div class="dashb-c-t2-c">
					<div class="dashb-c-p">
						<div class="dashb-c-p-r">
							...
							<div class="h1" id="html-allmoney"><?php  echo $today_money;?></div>
						</div>
					</div>
					<div class="dashb-c-p">
						<div class="dashb-c-p-r">
							<div class="h2">昨日支付金额(元)</div>
							<div class="h1" id="html-yesmoney"><?php  echo $yes_money;?></div>
						</div>
					</div>
					<div class="dashb-c-p">
						<div class="dashb-c-p-r">
							<div class="h2">近七日支付金额(元)</div>
							<div class="h1" id="html-sevenmoney"><?php  echo $seven_money;?></div>
						</div>
					</div>
					<div class="dashb-c-p">
						<div class="dashb-c-p-r">
							<div class="h2">近三十日支付金额(元)</div>
							<div class="h1" id="html-threemoney"><?php  echo $month_money;?></div>
						</div>
					</div>
				</div>
        ...
        $('#container').highcharts({
            ...
            series: [{
	            ...
	            data: [
	                ...
	                <?php  if($key>0) { ?>,<?php  } ?><?php  echo $row['team'];?>
	                <?php  } } ?>
	            ]
	        }, {
	            name: '签约订单',
