				...
				<table class="table table-hover">
					<thead>
						<tr>
							...
							<th class="text-center" style="width:40px;">推广医生</th>
...
<!-- 							<td class="text-center" style="position: relative;">
							...
							<td class="text-center" style="line-height:25px;">
								<span class="label label-success">余额：￥<?php  echo $item['countmoney'];?></span>
								<br>
							...
							<td class="text-center">
								<span><a href="<?php  echo $this->createWebUrl('apply',array('op'=>'next','id'=>$item['id'],'ac'=>'spreadlist'))?>">(成员<?php  echo $item['fenxiao'];?>人)</a></span>
							</td>
							<td class="text-center">
								<span><a href="<?php  echo $this->createWebUrl('apply',array('op'=>'next','id'=>$item['id'],'ac'=>'spreadlist'))?>">(成员<?php  echo $item['fenxiao'];?>人)</a></span>
							</td>
