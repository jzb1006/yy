...
<!--                     <div class="form-group">
                    ...
                    <span v-if="info.type == 1">
                        <div class="form-group" v-if="info.type == 2">
                            <label class="col-sm-2 control-label">公众号AppId<span class="must-fill">*</span></label>
                            <div class="col-sm-9">
                                <input type="text" v-model="info.app_id" name="pub_appid" required placeholder="请输入公众号appid" autocomplete="off" class="form-control" value="<?php  echo $res['pub_appid'];?>">
                            </div>
                        </div>
<!--                         <div class="form-group">
...
<!--                         <span v-if="info.shop_type == 2">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <button type="submit" class="btn btn-primary min-width" ><span>提交</span></button>
