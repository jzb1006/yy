...
<div class="app-container-right">
	...
	<li class="active"><a href="#tab_basic">文字设置</a></li>
</ul>
<div class="app-content">
<div class="app-form">
<?php  SESSION_START(); $_SESSION['is_submit'] = 0; ?>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="input-group">
							<span class="input-group-addon">热门话题=</span>
							<input type="text" name="hot_title" class="form-control" value="<?php  echo $item['hot_title'];?>">
							<span class="input-group-addon">今日推荐=</span>
							<input type="text" name="tj_title" class="form-control" value="<?php  echo $item['tj_title'];?>">
						</div>
					</div>
				</div>
			</div>
