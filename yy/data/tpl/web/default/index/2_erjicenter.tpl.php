...
<div class="app-content">
	<div class="app-filter">
		<div class="filter-action">
			<a class="btn btn-primary" href="/index.php?c=site&a=entry&do=copysite&m=hyb_yl&act=index.editmycenter&ac=mycenter&pid=<?php  echo $pid;?>">添加二级菜单</a>
		</div>
			...
			<table class="table table-hover table-bordered">
				...
				<?php  if(is_array($list)) { foreach($list as $item) { ?>
						<tr  class="text-center">
							...
							<td>
								<a class="btn btn-sm btn-warning" href="/index.php?c=site&a=entry&do=copysite&m=hyb_yl&act=index.editmycenter&ac=mycenter&id=<?php  echo $item['id'];?>&pid=<?php  echo $item['pid'];?>">编辑</a>
								<a class="btn btn-sm btn-danger" href="/index.php?c=site&a=entry&do=copysite&m=hyb_yl&act=index.delmycenter&ac=delmycenter&id=<?php  echo $item['id'];?>&pid=<?php  echo $item['pid'];?>" data-confirm="确定删除当前信息?">删除</a>
							</td>
						</tr>
						<?php  } } ?>
					</tbody>
