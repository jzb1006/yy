...
<div class="app-content">
	<div class="app-filter">
		<div class="filter-action">
			<a href="index.php?c=site&a=entry&do=copysite&m=hyb_yl&act=ceshi.addtag&ac=tag" class="btn btn-primary">添加标签</a>
			<!-- <a href="index.php?c=site&a=entry&do=copysite&m=hyb_yl&act=ceshi.addtagcaiji&ac=tag" class="btn btn-primary"></a> -->
			...
			<table class="table table-hover table-bordered">
				...
				<tbody>
					...
					<tr>
						...
						<td >
							<a class="btn btn-primary btn-sm" href="./index.php?c=site&a=entry&do=copysite&m=hyb_yl&act=ceshi.addtag&ac=tag&id=<?php  echo $item['id'];?>" title="">编辑</a>
							<a class="btn btn-sm btn-danger" data-toggle="ajaxRemove" href="./index.php?c=site&a=entry&do=copysite&m=hyb_yl&act=ceshi.deletetag&ac=tag&id=<?php  echo $item['id'];?>" data-confirm="删除标签会删除所有对应的标签记录,确认删除此标签？">删除</a>
						</td>
					</tr>
					<?php  } } ?>
				</tbody>
