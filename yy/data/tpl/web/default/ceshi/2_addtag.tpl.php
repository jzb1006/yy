...
<ul class="nav nav-tabs">
	<li ><a href="<?php  echo $this->copysiteUrl('ceshi.tag');?>&ac=tag">标签列表</a></li>
	<li <?php  if(empty($id)) { ?>class="active"<?php  } ?>><a href="<?php  echo $this->copysiteUrl('ceshi.addtag');?>&ac=tag">添加标签</a></li>
	<?php  if(!empty($id)) { ?>
