                                        ...
                                        $.ajax({
                                            ...
                                            success:function(res){
                                                ...
                                                for(var i=0;i<res.length;i++)
                                                {
                                                    html +="<div class='mb30'>";
                                                    html +="<div class='boxTitle'>";
                                                    html +="<span class='labelTip'></span>健康档案";
                                                    html +="</div>";
                                                    html +="<div class='boxBtn'>";
                                                    html +="<div role='radiogroup' class='el-radio-group floatL'>";
                                                    html +="<div class='el-radio-button is-active'>";
                                                    html +="<span class='el-radio-button__inner'>档案"+res[i].number+"</span>";
                                                    html +="</div>";
                                                    html +="</div>";
                                                    html +="</div>";
                                                    html +="</div>";
                                            ...
                                            <table class="table table-profile">
                                                ...
                                                <tbody id="J-points-infos-wrap">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                             <a class="btn btn-danger btn-sm" href="./index.php?c=site&a=entry&op=rechargeuser&do=copysite&m=hyb_yl&act=profile.delbg&ac=notice&a_id=<?php  echo $bg['a_id'];?>" data-toggle="ajaxRemove" data-confirm="删除报告，确定要删除吗？" title="删除">删除</a>
                                                        </td>
                                                    </tr>
                                                    <?php  } } ?>
                                                </tbody>
                    ...
                    <div class="m10">
                        ...
                        <div class="row">
                            <div class="form-group">
                                <label class="control-label">报告描述 <span class="asterisk">*</span>
                                </label>
                        ...
                        <div class="row">
                            <div class="form-group">
                                <label class="control-label">报告图片 <span class="asterisk">*</span>
                                </label>
